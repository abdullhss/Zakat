...
const FloatingDonationButton = () => {
  ...
  return (
    <button
      ...
      className="fixed top-24 px-2 py-2 lg:top-28 right-0   z-[1000] bg-white/90 backdrop-blur-sm rounded-l-xl lg:px-4 lg:py-2 flex items-center space-x-2 space-x-reverse shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-white"
      dir="rtl"
    >
