...
const DownloadApp = () => {
  return (
    <div className='bg-white py-24'>
        <div className='relative flex flex-col w-full md:flex-row px-2 md:px-28 items-center justify-between bg-[#ececec] py-16 pattern'>
            ...
            <div>
                <img src={Mobile} className='absolute -top-1/2 left-28'></img>
            </div>
        </div>
    </div>
  )
